...
- Отслеживание заказа. Входят фильтры, статус заказа, сколько заказал и вес, поставщики и их контакты, история заказов
- Прогноз дефицита: Если все рестораны в регионе разобрали клубнику, дашборд предлагает замороженную или редис как гарнир-замену.
- Сохранение поставщиков. Сохранение в профиле поставщиков с которыми шеф повар уже работал и хочет продолжать работать
- Создание приложения с мессенждером. Более крупная и рискованно идея для масштабирования, которую можно ввести ~через год после запуска сайта. Платформа может предполагать "разовую" авторизацию, уведомления, непосредственное общение с поставщиком через внутренний мессенждер
